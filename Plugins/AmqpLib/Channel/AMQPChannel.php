...
use AmqpLib\Exception\AMQPChannelClosedException;
use AmqpLib\Exception\AMQPConnectionBlockedException;
use AmqpLib\Exception\AMQPConnectionClosedException;
use AmqpLib\Exception\AMQPProtocolChannelException;
use AmqpLib\Exception\AMQPRuntimeException;
use AmqpLib\Helper\Assert;
...
class AMQPChannel extends AbstractChannel
{
     ...
     * @throws \AmqpLib\Exception\AMQPTimeoutException if the specified operation timeout was exceeded
     * @return mixed
     */
     ...
     * @param bool $auto_delete
     * @param bool $nowait
     * @param array|\AmqpLib\Wire\AMQPTable $arguments
     * @param int|null $ticket
     * @throws \AmqpLib\Exception\AMQPTimeoutException if the specified operation timeout was exceeded
     * @return array|null
     */
