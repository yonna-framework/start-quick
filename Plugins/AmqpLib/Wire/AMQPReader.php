...
class AMQPReader extends AbstractClient
{
    ...
    /** @var null|\AmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     *
     * @throws \AmqpLib\Exception\AMQPIOWaitException on network errors
     * @throws \AmqpLib\Exception\AMQPTimeoutException when timeout is set and no data received
     * @throws \AmqpLib\Exception\AMQPNoDataException when no data is ready to read from IO
     */
     ...
     * @throws \AmqpLib\Exception\AMQPDataReadException
     * @throws \AmqpLib\Exception\AMQPNoDataException
     */
