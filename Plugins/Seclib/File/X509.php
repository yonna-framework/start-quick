...
namespace Seclib\File;

use Seclib\Crypt\Hash;
use Seclib\Crypt\Random;
use Seclib\Crypt\RSA;
use Seclib\File\ASN1\Element;
use Seclib\Math\BigInteger;
use DateTime;
use DateTimeZone;
...
class X509
{
    ...
    */
    ...
    /**#@+
     * @access public
     * @see \Seclib\File\X509::saveX509()
     * @see \Seclib\File\X509::saveCSR()
     * @see \Seclib\File\X509::saveCRL()
    */
    /**
     * Save as PEM
     *
     ...
     *
     * There's no guarantee \Seclib\File\X509 is going to re-encode an X.509 cert in the same way it was originally
    ...
    function __construct()
    {
        ...
        */
        ...
        $AdministrationDomainName = array(
            'type'     => ASN1::TYPE_CHOICE,
            // if class isn't present it's assumed to be \Seclib\File\ASN1::CLASS_UNIVERSAL or
            // (if constant is present) \Seclib\File\ASN1::CLASS_CONTEXT_SPECIFIC
        ...
        $EDIPartyName = array(
            ...
            'children' => array(
                 ...
                 // partyName is technically required but \Seclib\File\ASN1 doesn't currently support non-optional constants and
        ...
        $this->oids = array(
            ...
            // the following are X.509 extensions not supported by Seclib
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \Seclib\File\ASN1::TYPE_IA5_STRING.
           \Seclib\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
                    ...
                    case 'id-ce-certificatePolicies':
                        for ($j = 0; $j < count($value); $j++) {
                            ...
                            for ($k = 0; $k < count($value[$j]['policyQualifiers']); $k++) {
                                ...
                                $subvalue = &$value[$j]['policyQualifiers'][$k]['qualifier'];
                                if ($map !== false) {
                                    // by default \Seclib\File\ASN1 will try to render qualifier as a \Seclib\File\ASN1::TYPE_IA5_STRING since it's
                                    // actual type is \Seclib\File\ASN1::TYPE_ANY
    ...
    {
        if (!is_string($extnId)) { // eg. if it's a \Seclib\File\ASN1\Element object
            return true;
        }
     ...
     *
     * Reformats a public key to a format supported by Seclib (if applicable)
     *
     ...
     * Set public key
     *
     * Key needs to be a \Seclib\Crypt\RSA object
     *
     * @param object $key
     * @access public
     * @return bool
     ...
     * Gets the public key
     *
     * Returns a \Seclib\Crypt\RSA object or a false.
     *
     * @access public
     * @return mixed
     */
    ...
    function saveSPKAC($spkac, $format = self::FORMAT_PEM)
    {
        ...
        switch ($format) {
            ...
            default:
                ...
                // no other SPKAC decoders Seclib will use that same format
     ...
     *
     * @param \Seclib\File\X509 $issuer
     * @param \Seclib\File\X509 $subject
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(array('\Seclib\File\X509', '_dnsName'), $subject->domains);
        }
        ...
        // save $tbsCertificate in case there are any \Seclib\File\ASN1\Element objects in it
    ...
    function signCSR($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $certificationRequestInfo in case there are any \Seclib\File\ASN1\Element objects in it
    ...
    function signSPKAC($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $publicKeyAndChallenge in case there are any \Seclib\File\ASN1\Element objects in it
    ...
    function signCRL($issuer, $crl, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $tbsCertList in case there are any \Seclib\File\ASN1\Element objects in it
        $tbsCertList = $this->currentCert['tbsCertList'];
     ...
     * - Key object
     * - \Seclib\File\X509 object with public or private key defined
     * - Certificate or CSR array
     * - \Seclib\File\ASN1\Element object
     * - PEM or DER string
     *
    ...
    function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \Seclib\Crypt\RSA).
     ...
     * of Seclib may not be unmapped in the next version, so apps that are looking at this OID may not be able
