...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \Seclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \Seclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \Seclib\Crypt\RSA::createKey()
     * @see \Seclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \Seclib\Crypt\RSA::createKey()
     * @see \Seclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \Seclib\Math\BigInteger objects.
     *
     ...
     * @access private
     */
    var $comment = 'Seclib-generated-key';

    /**
     * The constructor
     *
     * If you want to make use of the openssl extension, you'll need to set the mode manually, yourself.  The reason
     * \Seclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \Seclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \Seclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
     ...
     * exponent this won't work unless you manually add the public exponent. Seclib tries to guess if the key being used
     ...
     *
     * If Seclib guessed a private key was a public key and loaded it as such it might be desirable to force
     * Seclib to treat the key as a private key. This function will do that.
     *
     * Do note that when a new key is loaded the index will be cleared.
     *
     * Returns true on success, false on failure
    ...
    {
        // \Seclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     *
     * @access private
     * @param \Seclib\Math\BigInteger $x
     * @param int $xLen
     * @return string
     */
     ...
     * @access private
     * @param \Seclib\Math\BigInteger $x
     * @param \Seclib\Math\BigInteger $r
     * @param int $i
     * @return \Seclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \Seclib\Math\BigInteger $m
     * @return \Seclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \Seclib\Math\BigInteger $c
     * @return \Seclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \Seclib\Math\BigInteger $s
     * @return \Seclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \Seclib\Crypt\RSA may not decrypt
