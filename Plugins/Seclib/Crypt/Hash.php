 ...
 *
 *    $hash = new \Seclib\Crypt\Hash('sha1');
 *
 *    $hash->setKey('abcdefg');
 *
...
class Hash
{
    /**#@+
     * @access private
     * @see \Seclib\Crypt\Hash::__construct()
     */
    /**
    ...
    function _sha512($m)
    {
        ...
        // Produce the final hash value (big-endian)
        // (\Seclib\Crypt\Hash::hash() trims the output for hashes but not for HMACs.  as such, we trim the output here)
