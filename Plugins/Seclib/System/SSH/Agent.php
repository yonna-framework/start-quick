 ...
 *
 *    $agent = new \Seclib\System\SSH\Agent();
 *
...
namespace Seclib\System\SSH;

use Seclib\Crypt\RSA;
use Seclib\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \Seclib\System\SSH\Agent\Identity objects
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  public
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \Seclib\System\SSH\Agent
     * @access public
     */
     ...
     * Returns an array containing zero or more \Seclib\System\SSH\Agent\Identity objects
     *
     * @return array
     * @access public
     */
