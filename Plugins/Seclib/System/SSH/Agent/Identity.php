...
namespace Seclib\System\SSH\Agent;
 ...
 *
 * Instantiation should only be performed by \Seclib\System\SSH\Agent class.
 * This could be thought of as implementing an interface that Seclib\Crypt\RSA
 * implements. ie. maybe a Net_SSH_Auth_PublicKey interface or something.
 * The methods in this interface would be getPublicKey and sign since those are the
 * methods Seclib looks for to perform public key authentication.
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  internal
...
class Identity
{
     ...
     * @return \Seclib\System\SSH\Agent\Identity
     * @access private
     */
     ...
     * Set Public Key
     *
     * Called by \Seclib\System\SSH\Agent::requestIdentities()
     *
     * @param \Seclib\Crypt\RSA $key
     * @access private
     */
     ...
     * Set Public Key
     *
     * Called by \Seclib\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
     ...
     * ssh-agent's only supported mode is \Seclib\Crypt\RSA::SIGNATURE_PKCS1
     *
     * @param int $mode
     * @access public
     */
