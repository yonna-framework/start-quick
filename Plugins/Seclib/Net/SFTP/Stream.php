...
class Stream
{
    ...
    function _parse_path($path)
    {
        ...
        if ($host[0] == '$') {
            ...
            // casting $pass to a string is necessary in the event that it's a \Seclib\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \Seclib\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \Seclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \Seclib\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \Seclib\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
