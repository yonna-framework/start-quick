 ...
 *
 *    $sftp = new \Seclib\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
     ...
     *
     * \Seclib\Net\SSH2::exec() uses 0 and \Seclib\Net\SSH2::read() / \Seclib\Net\SSH2::write() use 1.
     *
    ...
    */
    ...
    function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // the order, in this case, matters quite a lot - see \Seclib\Net\SFTP::_parseAttributes() to understand why
        ...
        // see \Seclib\Net\SFTP::_parseLongname() for an explanation
    ...
    function login($username)
    {
        ...
        */
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \Seclib\Net\SFTP would do is close the
    ...
    function chdir($dir)
    {
        ...
        // see \Seclib\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->_get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \Seclib\Net\SFTP::realpath().
     ...
     *
     * By default, \Seclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Seclib\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     * @return bool
     * @access public
     * @internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \Seclib\Net\SFTP::setMode().
     */
