 ...
 *
 *    $ssh = new \Seclib\Net\SSH1('www.domain.tld');
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \Seclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \Seclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \Seclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
    ...
    */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \Seclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \Seclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \Seclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
