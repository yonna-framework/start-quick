...
class SCP
{
    ...
    /**#@+
     * @access private
     * @see \Seclib\Net\SCP::_send()
     * @see \Seclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \Seclib\Net\SSH1|\Seclib\Net\SSH2 $ssh
     * @return \Seclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \Seclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Seclib\Net\SCP::get(), you will get a file, twelve bytes
